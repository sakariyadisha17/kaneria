...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo e(url('app-assets/css/pages/login-register.min.css')); ?>">
    <!-- END: Page CSS-->
    <!-- BEGIN: Custom CSS-->
  ...
  <body class="vertical-layout vertical-menu-modern 1-column   blank-page blank-page" data-open="click" data-menu="vertical-menu-modern" data-col="1-column">
                        ...
                        <div class="card border-grey border-lighten-3 m-0">
                            <div class="card-header border-0">
                                <div class="card-title text-center">
                                    <div class="p-1">
                                        <img src="<?php echo e(url('logos/logo.jpg')); ?>"
                                ...
                                <div class="card-body">
                                    <?php echo $__env->make('notifications', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-6 col-12 text-center text-sm-right"><a href="<?php echo e(url('/forgetPassword')); ?>"
    ...
    <script src="<?php echo e(url('app-assets/vendors/js/forms/icheck/icheck.min.js')); ?>"></script>
    <script src="<?php echo e(url('app-assets/vendors/js/forms/validation/jqBootstrapValidation.js')); ?>"></script>
    <!-- END: Page Vendor JS-->
    <!-- BEGIN: Theme JS-->
    ...
    <!-- END: Theme JS-->
    <!-- BEGIN: Page JS-->
    <script src="<?php echo e(url('app-assets/js/scripts/forms/form-login-register.min.js')); ?>"></script>
    <!-- END: Page JS-->
  </body>
  <!-- END: Body-->
</html><?php /**PATH D:\wamp64\www\old_project\kaneria\resources\views/auth/login.blade.php ENDPATH**/ ?>