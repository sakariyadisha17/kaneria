...
class HomeController extends Controller
{
    ...
    {
        return view('receptionist.patient.day_list', [
            'date' => $request->date,
            'month' => $request->month,
    ...
    public function bookfor()
    {
        return view('receptionist.booking');
    }
    ...
    public function storeBooking(Request $request)
    {
        ...
        $message = str_replace("[time]", date('h:i A', strtotime($timeSlot->time_sheet)), $message);
