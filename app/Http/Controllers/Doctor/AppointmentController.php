...
class AppointmentController extends Controller
{
    ...
    public function showFile($id)
    {
        ...
        return view('doctor.appointment.showfile', compact('patientFiles', 'id'));
    }
    ...
    public function generatePDF($id)
    {
        ...
        $pdf = PDF::loadView('doctor.appointment.generatepdf', compact('patientFiles', 'patientName', 'patientAge', 'patientPhone' ,'patientAddress'));
    ...
    public function exportPDF(Request $request)
    {
        ...
        $pdf = PDF::loadView('doctor.appointment.pdf', compact('patients', 'cashTotal', 'onlineTotal', 'debitTotal', 'totalAmount', 'selectedDate'))
      ...
      public function showletter($id)
    {
        ...
        if (!$patient) {
            return redirect()->route('doctor.appointments.data')->with('error', 'Patient not found.');
        }

        return view('doctor.appointment.letterhead', compact('patient','diagnosis'));
    }
    ...
    public function getDiagnosisDetails(Request $request)
    {
        ...
        ->where('diagnosis_medicine.diagnosis_id', $diagnosisId)
        ->get();
    
        // Fetch the diet chart and note
    ...
    public function storeLetterhead(StoreOpdLetterheadRequest $request, $id)
    {
        try {
            ...
            $letterhead->diagnosis = $request->diagnosis;
