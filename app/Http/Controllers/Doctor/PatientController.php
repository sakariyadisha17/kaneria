...
class PatientController extends Controller
{
    ...
    public function destroy($id)
    {
        try {
            ...
            return redirect('doctor/patients')->with('success', 'Patient deleted successfully!');
        } catch (\Exception $ex) {
            Log::error('Error deleting patient: ' . $ex->getMessage());
            return redirect('doctor/patients')->with('error', 'An error occurred while deleting the patient. ' . $ex->getMessage());
        }
    }
