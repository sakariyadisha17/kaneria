...
class DoseController extends Controller
{
    ...
    {
        try {
			return view( 'doctor.patient_dose.list');
		} catch ( \Exception $ex ) {
    ...
    public function getData(Request $request)
    {
        ...
        return DataTables::of($query)
            ->addColumn('action', function ($row) {
                $letterheadUrl = URL('doctor/patient_dose/letterhead/' . $row->id); 
                $showUrl = URL('doctor/patient_dose/show/' . $row->id);  // Fixed URL
        
                // $showButton = '<a href="' . $showUrl . '" title="View Record" class="btn text-secondary">
                //                 <i class="fa fa-eye"></i>
                //             </a>';
                ...
                $openUrl = URL('doctor/patient_dose/' . $row->id . '/open');  
    ...
    public function dose_page($id)
    {
        ...
        if (!$patient) {
            return redirect()->route('doctor.patient_dose.data')->with('error', 'Patient not found.');
        }

        return view('doctor.patient_dose.dose' , compact('patient','diagnosis'));
    }
    ...
    public function showdata($id)
    {
        ...
        return view('doctor.patient_dose.show', compact('vital', 'medicines', 'patient'));
    }

    public function showFile($id)
    {
        $patientFiles = PatientFile::where('patient_id', $id)->get();
        return view('doctor.patient_dose.showfile', compact('patientFiles', 'id'));
    }
    ...
    public function generatePDF($id)
    {
        ...
        $pdf = PDF::loadView('doctor.patient_dose.generatepdf', compact('patientFiles', 'patientName', 'patientAge', 'patientPhone' ,'patientAddress'));
