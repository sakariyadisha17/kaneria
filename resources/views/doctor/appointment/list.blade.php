                                ...
                                <div class="card-body card-dashboard">
                                    <div class="card-header text-right">
                                        <div class="btn-group" style="gap: 9px !important;"> 
                                            <!-- <a href="{{ route('doctor.appointments.exportPDF') }}" class="btn btn-primary"><i class="fa fa-plus"></i> PDF</a> 
                                            <a href="{{ route('doctor.appointments.exportCSV') }}" class="btn btn-info"><i class="fa fa-plus"></i> CSV</a> -->
...
<script>
    function exportFile(type) {
        ...
        const base = type === 'pdf' 
            ? "{{ route('doctor.appointments.exportPDF') }}" 
            : "{{ route('doctor.appointments.exportCSV') }}";
...
<script type="text/javascript">
    $(document).ready(function () {
        var table = $('#patient-table').DataTable({
            ...
            ajax: {
                url: "{{ route('doctor.appointments.data') }}",
                data: function (d) {
...
$.ajax({
    url: '{{ route("doctor.appointments.uploadFiles") }}',
    type: 'POST',
    data: formData,
    contentType: false,
    processData: false,
