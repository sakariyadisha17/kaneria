                ...
                <div class="row">
                    <div class="col-12">
                        <div class="text-right mr-2">
                            <a href="{{url('doctor/patient_dose')}}" class="btn btn-info">
                                    ...
                                    <div class="col-md-3">
                                     ...
                                     <div class="col-md-9">
                                        ...
                                        <div class="form-groups">
                                            ...
                                            <select class="form-control select2" id="diagnosis_id" name="diagnosis_id">
                                        ...
                                        <div class="form-groups">
                                                    <label><h5>Patient Note:</h5></label>
                                                    <textarea class="form-control" name="patient_note" rows="3" placeholder="Patient note"></textarea>
                                        </div><br>
