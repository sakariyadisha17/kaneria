...
<div class="app-content content">
    ...
    <div class="content-wrapper">
        ...
        <div class="text-right">
            <div class="btn-group">
                <a href="{{ url('nursing/treatment_sheet') }}" class="btn btn-info"><i class="fas fa-arrow-left"></i> Back</a> 
            </div>
        </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-content collapse show">
                                ...
                                <a href="{{ route('nursing.generate.pdf', $id) }}" class="btn btn-primary mb-3">Generate PDF</a>
