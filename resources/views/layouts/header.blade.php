...
<html class="loading" lang="en" data-textdirection="ltr">
	<head>
		...
		<link rel="stylesheet" type="text/css" href="{{url('/app-assets/css/pages/card-statistics.min.css')}}">
		<link rel="stylesheet" type="text/css" href="{{url('/app-assets/css/pages/vertical-timeline.min.css')}}">
		<link rel="icon" type="image/x-icon" href="{{url('/app-assets/images/logo/stack-logo.png')}}">
