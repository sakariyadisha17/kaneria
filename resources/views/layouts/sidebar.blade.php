...
<div class="main-menu menu-fixed menu-dark menu-accordion menu-shadow" data-scroll-to-active="true">
    <div class="main-menu-content">
        ...
        @hasrole('Admin')
            ...
            <li class="nav-item has-sub @if(Request::is('master', 'master/*') || Request::is('doctor/*') || Request::is('times') || Request::is('charges')) menu-collapsed-open active @endif">
                <a href="#">
                ...
                <ul class="menu-content">
                    <li class="@if(Request::is('admin/doctors')) active @endif">
                        <a class="menu-item" href="{{ URL('admin/doctors') }}" data-i18n="Add doctor">
                            <i class="feather icon-list"></i>Doctor List
                        </a>
                    </li>
                    
                    <li class="@if(Request::is('admin/times')) active @endif">
                        <a class="menu-item" href="{{ URL('admin/times') }}" data-i18n="master times">
                            <i class="feather icon-plus"></i>Time
                        </a>
                    </li>
                    <li class="@if(Request::is('admin/charges')) active @endif">
                        <a class="menu-item" href="{{ URL('admin/charges') }}" data-i18n="master charges">
                            <i class="feather icon-check-circle"></i>Charge
                        </a>
                    </li>
                    <li class="@if(Request::is('admin/services')) active @endif">
                        <a class="menu-item" href="{{ URL('admin/services') }}" data-i18n="master services">
                            <i class="fa fa icon-target"></i>Service
                        </a>
                    </li>

                    <li class="@if(Request::is('admin/medicine')) active @endif">
                        <a class="menu-item" href="{{ URL('admin/medicine') }}" data-i18n="master medicine">
                            <i class="fa-solid fa-sheet-plastic"></i>Medicine
                        </a>
                    </li>

                    <li class="@if(Request::is('admin/diagnosis')) active @endif">
                        <a class="menu-item" href="{{ URL('admin/diagnosis') }}" data-i18n="master diagnosis">
                            <i class="feather icon-activity"></i>Diagnosis
                        </a>
                    </li>

                    <li class="@if(Request::is('admin/rooms')) active @endif">
                        <a class="menu-item" href="{{ URL('admin/rooms') }}" data-i18n="master rooms">
                            <i class="feather icon-plus-circle"></i>Room
                        </a>
                    </li>

                    <li class="@if(Request::is('admin/beds')) active @endif">
                        <a class="menu-item" href="{{ URL('admin/beds') }}" data-i18n="master beds">
        ...
        @hasrole('Doctor')            
            ...
            <li class="nav-item">
                <a href="{{url('doctor/patient_dose')}}">
        ...
        @hasrole('Medical Officer')            
            ...
            <li class="nav-item">
                <a href="{{url('medical_officer/dashboard')}}">
                    <i class="fa-solid fa-house-user"></i>
                    <span class="menu-title"style="color:#fff;" data-i18n="Dashboard">Dashboard</span>
                </a>
            </li>   
            ...
            <li class="nav-item">
                <a href="{{url('medical_officer/vitals')}}">
                    <i class="fa-solid fa-bed-pulse"></i>
                    <span class="menu-title"style="color:#fff;" data-i18n="vitals">Patient Vitals</span>
                </a>
            </li>  
            <li class="nav-item">
                <a href="{{url('medical_officer/patients')}}">
                    <i class="fa-solid fa-bed"></i>
            ...
            <li class="nav-item">
                <a href="{{url('medical_officer/patient_dose')}}">
                    <i class="fa-solid fa-sheet-plastic"></i>
                    <span class="menu-title"style="color:#fff;" data-i18n="Patient">Indoor sheet</span>
                </a>
            </li> 
            <li class="nav-item">
                <a href="{{url('medical_officer/to_do_list')}}">
                    <i class="fa-solid fa-list-check"></i>
                    <span class="menu-title"style="color:#fff;" data-i18n="Patient">To do list</span>
                </a>
            </li> 
            <li class="nav-item">
                <a href="{{url('medical_officer/discharge_summary')}}">
        ...
        @hasrole('Nursing')           
            ...
            <li class="nav-item">
                <a href="{{url('nursing/dashboard')}}">
                    <i class="fa-solid fa-house-user"></i>
                    <span class="menu-title"style="color:#fff;" data-i18n="Dashboard">Dashboard</span>
                </a>
            </li>    
            <li class="nav-item">
                <a href="{{url('nursing/patients')}}">
                    <i class="fa-solid fa-bed"></i>
                    <span class="menu-title"style="color:#fff;" data-i18n="Patient">Admit Patient</span>
                </a>
            </li>    
            <li class="nav-item">
                <a href="{{url('nursing/patient_dose')}}">
                    <i class="fa-solid fa-syringe"></i>
                    <span class="menu-title"style="color:#fff;" data-i18n="dose">Patient Dose</span>
                </a>
            </li> 
            <li class="nav-item">
                <a href="{{url('nursing/treatment_sheet')}}">
                    <i class="fa-solid fa-sheet-plastic"></i>
                    <span class="menu-title"style="color:#fff;" data-i18n="treatment">Treatment sheet</span>
                </a>
            </li>
            <li class="nav-item">
                <a href="{{url('nursing/to_do_list')}}">
                    <i class="fa-solid fa-list-check"></i>
                    <span class="menu-title"style="color:#fff;" data-i18n="Patient">To do list</span>
                </a>
            </li> 
            <li class="nav-item">
                <a href="{{url('nursing/vitals_chart')}}">
                    <i class="fa-solid fa-bed-pulse"></i>
        ...
        @hasrole('Receptionist')
            ...
            <li class="nav-item">
                <a href="{{url('receptionist/booking')}}">
            ...
            <li class="nav-item">
                <a href="{{url('receptionist/patient')}}">
                    <i class="fa-solid fa-wheelchair"></i>
            ...
            <li class="nav-item">
                <a href="{{url('receptionist/vitals')}}">
                    <i class="fa-solid fa-bed-pulse"></i>
                    <span class="menu-title"style="color:#fff;" data-i18n="vitals">Patient Vitals</span>
                </a>
            </li>
            <li class="nav-item">
                <a href="{{url('receptionist/patients')}}">
                    <i class="fa fa-search"></i>
                    <span class="menu-title"style="color:#fff;" data-i18n="vitals">Patient List</span>
                </a>
            </li>
            <li class="nav-item">
                <a href="{{url('receptionist/reports')}}">
