...
@section('content')
    ...
    <div class="app-content content">
                            ...
                            <div class="card-content">
                                <div class="media align-items-stretch">
                                    ...
                                    <div class="p-2 bg-gradient-x-info white media-body">
                                        ...
                                        {{-- <h6>Total Amount: ₹{{ number_format($today_total_ecg_amount, 2) }}</h6> --}}
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-content">
                                <div class="media align-items-stretch">
                                    ...
                                    <div class="p-2 bg-gradient-x-warning white media-body">
                                        <h5>ECG Payment</h5>
                                        <h3 id="ecgAmount" class="text-bold-400 mb-0">₹ {{ number_format($today_total_ecg_amount) }} </h3>
            ...
            <div class="row g-4">
                ...
                <div class="col-md-3">
                    <div class="pay-card total">
                        <div class="pay-header">
                            ...
                            <h3 id="totalPayment">₹ {{ number_format($total_payment) }}</h3>
                        </div>
                ...
                <div class="col-md-3">
                    <div class="pay-card cash">
                        <div class="pay-header">
                            <span>Cash</span>
                            <h3 id="cashPayment">₹ {{ number_format($cash_payment) }}</h3>
                        </div>
                ...
                <div class="col-md-3">
                    <div class="pay-card online">
                        <div class="pay-header">
                            <span>Online</span>
                            <h3 id="onlinePayment">₹ {{ number_format($online_payment) }}</h3>
                        </div>
                ...
                <div class="col-md-3">
                    <div class="pay-card debit ">
                        <div class="pay-header">
                            <span>Debit</span>
                            <h3>₹ {{ number_format($debit_payment) }}</h3>
                        </div>
        ...
        {{-- <div class="mb-3 text-center">
            <button class="btn btn-primary me-2" onclick="showChart('weekly')">Daily</button>
            <button class="btn btn-secondary me-2" onclick="showChart('monthly')">Monthly</button>
            <button class="btn btn-secondary" onclick="showChart('yearly')">Yearly</button>
        </div> --}}
...
document.addEventListener('DOMContentLoaded', function () {
        ...
        chart: {
            ...
            events: {
                dataPointSelection: function (event, chartContext, config) {
                    ...
                    // If already clicked → this is DOUBLE CLICK
                    if (clickTimer) {
                        clearTimeout(clickTimer);
                        clickTimer = null;
                        ...
                        window.location.href =
                            `/receptionist/dashboard/patient-list?date=${date}&type=${type}`;
                        return;
                    }
                    ...
                    clickTimer = setTimeout(() => {
                        ...
                        // 🔹 SINGLE CLICK → update dashboard
                        fetch(`/receptionist/dashboard/day-data?date=${date}`)
                            .then(res => res.json())
    ...
    var chart = new ApexCharts(
        document.querySelector("#weeklyPatientChart"),
        options
    );

    chart.render();

    fetch('/receptionist/dashboard/weekly-patient-chart')
        .then(res => res.json())
        .then(data => {
