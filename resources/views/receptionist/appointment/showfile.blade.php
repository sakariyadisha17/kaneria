...
<div class="app-content content">
    ...
    <div class="content-wrapper">
        ...
        <div class="text-right">
            <div class="btn-group">
                <a href="{{ url('receptionist/appointments') }}" class="btn btn-info" style="border-radius: 50px;"><i class="fas fa-arrow-left"></i></a> 
            </div>
        </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-content collapse show">
                                ...
                                <a href="{{ route('generate.pdf', $id) }}" class="btn btn-primary mb-3">Generate PDF</a>
