            ...
            <section id="column">
                <div class="row">
                    <div class="col-12">
                        ...
                        <form method="POST" action="{{ route('medical_officer.letterhead.save', ['id' => $patient->id]) }}">
                            @csrf
                            <input type="hidden" name="patient_id" value="{{ $patient->id }}">
                            <input type="hidden" name="appointment_id" value="{{ $patient->appointment_id  }}">
                            <div class="letterhead container p-4">
                                <!-- Date and Time -->
                                <h5 style="font-weight : 500;">Patient Name  : {{@$patient->fullname}} , Age :{{@$patient->age}} Year's </h5>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <div class="col-md-9" style="padding: 10px;">
                                            ...
                                            <div class="form-groups" style="margin-bottom: 15px;">
                                                ...
                                                <select class="form-control select2" id="diagnosis_id" name="diagnosis_id" style="width: 100%;">
                                            ...
                                            <div class="form-groups" style="margin-bottom: 15px;">
                                                <label><h5 style="margin: 0;">Patient Note:</h5></label>
                                                <textarea class="form-control" name="patient_note" rows="3" placeholder="Patient note" style="width: 100%;"></textarea>
                                            </div>
...
$('#saveDetailsBtn').click(function (e) {
    ...
    var data = {
        ...
        patient_note: $('textarea[name="patient_note"]').val(),
        diagnosis_id: $('select[name="diagnosis_id"]').val(),

        datetime: $('input[name="datetime"]').val(),
        medicines: medicines 
    };
    $.ajax({
        url: '{{ route("medical_officer.letterhead.save", ":id") }}'.replace(':id', '{{ $patient->id }}'),
        method: 'POST',
