...
<div class="app-content content">
    ...
    <div class="content-wrapper">
        ...
        <div class="text-right">
            <div class="btn-group">
                <a href="{{ url('medical_officer/appointments') }}" class="btn btn-info" style="border-radius: 50px;"><i class="fas fa-arrow-left"></i></a> 
            </div>
        </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-content collapse show">
                                ...
                                <a href="{{ route('medical_officer.generate.pdf', $id) }}" class="btn btn-primary mb-3">Generate PDF</a>
                                        ...
                                        <tbody>
                                            @foreach ($patientFiles as $patient)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <form action="{{ route('patient-files.destroy', $patient->id) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this file?');">
                                                            @csrf
                                                            @method('DELETE')
