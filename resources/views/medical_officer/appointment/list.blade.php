                                ...
                                <div class="card-body card-dashboard">
                                    <div class="card-header text-right">
                                        <div class="btn-group" style="gap: 10px !important;">
                                            <!-- <a href="{{ route('medical_officer.appointments.exportPDF') }}" class="btn btn-primary"><i class="fa fa-plus"></i> PDF</a> 
                                            <a href="{{ route('medical_officer.appointments.exportCSV') }}" class="btn btn-info"><i class="fa fa-plus"></i> CSV</a> -->
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="file" id="file_input" class="form-control" accept="image/*,.pdf" capture="environment">
                    </div>
...
<script>
    function exportFile(type) {
        ...
        const base = type === 'pdf' 
            ? "{{ route('medical_officer.appointments.exportPDF') }}" 
            : "{{ route('medical_officer.appointments.exportCSV') }}";
...
<script type="text/javascript">
    $(document).ready(function () {
        var table = $('#patient-table').DataTable({
            ...
            ajax: {
                url: "{{ route('medical_officer.appointments.data') }}",
                data: function (d) {
        ...
        $('#patient-table').on('change', '.change-status', function () {
            ...
            $.ajax({
                url: '{{ route("medical_officer.appointments.updateStatus") }}',
                method: 'POST',
                data: {
                    _token: '{{ csrf_token() }}',
                    id: id,
...
$.ajax({
    url: '{{ route("medical_officer.appointments.uploadFiles") }}',
    type: 'POST',
    data: formData,
    contentType: false,
    processData: false,
